...
import { downloadOutline, gift, giftOutline, chevronForward, chevronBack, chevronDown, chevronUp, flame, trophy, wallet, person, personCircleOutline, menu, lockClosed, cash, ribbon, sparkles, pricetag, logoAndroid, logoApple, headset, eyeOutline, eyeOffOutline, documentText, heart, shieldCheckmark, logOut, refresh, bag, chatbubbleOutline, copyOutline, informationCircleOutline, search, gameController, extensionPuzzle, helpCircleOutline, logoFacebook, logoWhatsapp, logoInstagram, logoTwitter, logoTiktok, logoYoutube, send, videocam, timeOutline, cashOutline, openOutline, close, checkmarkCircle, diamond, warning } from 'ionicons/icons'
addIcons({ 'download-outline': downloadOutline, gift, 'gift-outline': giftOutline, 'chevron-forward': chevronForward, 'chevron-back': chevronBack, 'chevron-down': chevronDown, 'chevron-up': chevronUp, flame, trophy, wallet, person, 'person-circle-outline': personCircleOutline, menu, 'lock-closed': lockClosed, cash, ribbon, sparkles, pricetag, 'logo-android': logoAndroid, 'logo-apple': logoApple, headset, 'eye-outline': eyeOutline, 'eye-off-outline': eyeOffOutline, 'document-text': documentText, heart, 'shield-checkmark': shieldCheckmark, 'log-out': logOut, refresh, bag, 'chatbubble-outline': chatbubbleOutline, 'copy-outline': copyOutline, 'information-circle-outline': informationCircleOutline, search, 'game-controller': gameController, 'extension-puzzle': extensionPuzzle, 'help-circle-outline': helpCircleOutline, 'logo-facebook': logoFacebook, 'logo-whatsapp': logoWhatsapp, 'logo-instagram': logoInstagram, 'logo-twitter': logoTwitter, 'logo-tiktok': logoTiktok, 'logo-youtube': logoYoutube, send, videocam, 'time-outline': timeOutline, 'cash-outline': cashOutline, 'open-outline': openOutline, close, 'checkmark-circle': checkmarkCircle, diamond, warning })
